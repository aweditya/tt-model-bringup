...
print(f"\n{'='*60}")
print(f"RESULTS: Llama-3.2-3B on Blackhole P150")
print(f"{'='*60}")
...
print(f"  Text: {text}")
print(f"\n  Comparison:")
print(f"    Qwen2.5-0.5B:  7.1ms/tok (140 tok/sec)")
print(f"    Qwen3-0.6B:   13.2ms/tok  (76 tok/sec)")
print(f"    Llama-3.2-1B:  12.8ms/tok  (78 tok/sec)")
