#!/usr/bin/env python3
"""Install the owned qwen36_gdn_decode_owned op into a TT-Metal checkout.
...
OP_NAME = "qwen36_gdn_decode_owned"
...
def main() -> int:
    ...
    if not (source_dir / "qwen36_gdn_decode_owned.cpp").is_file():
