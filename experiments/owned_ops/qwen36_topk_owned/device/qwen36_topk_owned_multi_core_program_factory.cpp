...
static inline std::tuple<uint16_t, uint16_t, uint16_t, uint16_t, uint16_t, uint16_t> cores_utilized(
    ...
    const auto config_opt = find_qwen36_topk_owned_core_config(
...
Qwen36TopkOwnedMultiCoreProgramFactory::cached_program_t Qwen36TopkOwnedMultiCoreProgramFactory::create(
...
void Qwen36TopkOwnedMultiCoreProgramFactory::override_runtime_arguments(
