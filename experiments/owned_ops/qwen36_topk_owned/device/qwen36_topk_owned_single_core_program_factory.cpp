...
Qwen36TopkOwnedSingleCoreProgramFactory::cached_program_t Qwen36TopkOwnedSingleCoreProgramFactory::create(
...
void Qwen36TopkOwnedSingleCoreProgramFactory::override_runtime_arguments(
