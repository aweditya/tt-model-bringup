...
| **v0.4.0h** | **MoE host paths on-device** (#226). Router topk, combine weighted-sum, shared+residual all on-device. ~30-80 ms/step projected. | n-step chain ≥ 6/7 PASS + moe share drop | pending |
