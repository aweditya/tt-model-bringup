...
print(f"\n{'='*60}")
print("RESULTS: SmolLM3-3B on Blackhole P150")
print(f"{'='*60}")
...
print(f"  Text: {text}")
print("\n  Comparison:")
print("    Qwen2.5-0.5B:   7.1ms/tok (140 tok/sec) — head_dim=64, 2 KV heads")
print("    Qwen3-0.6B:    13.2ms/tok  (76 tok/sec) — head_dim=128, 8 KV (split)")
print("    Llama-3.2-1B:  12.8ms/tok  (78 tok/sec) — head_dim=64, 8 KV (split)")
print("    Llama-3.2-3B:  29.7ms/tok  (34 tok/sec) — head_dim=128, 8 KV (split)")
