...
print(f"  Text: {text}")
print("\n  Comparison:")
print("    Qwen2.5-0.5B: 7.1ms/tok (140 tok/sec) — 24 layers, 896 hidden, head_dim=64")
print(f"    Qwen3-0.6B:   {avg_ms:.1f}ms/tok ({tps:.0f} tok/sec) — 28 layers, 1024 hidden, head_dim=128")
print("    Llama-3.2-1B:  12.8ms/tok (78 tok/sec) — 16 layers, 2048 hidden, head_dim=64")
